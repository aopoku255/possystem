                ...
                <Card className="mt-4">
                  <CardBody className="p-4">
                    <div className="text-center mt-2">
                      <h5 className="text-primary">Create Your Store</h5>
                      <p className="text-muted">Enter Store Information</p>
                    </div>
                      ...
                      >
                        ...
                        <div className="mb-4">
                          <p className="mb-0 fs-12 text-muted fst-italic">
                            By registering you agree to the ANDTECX
                            <Link
                              to="#"
